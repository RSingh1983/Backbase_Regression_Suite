...
Feature: Home Page Menus, Links and UI Elements Validation
  ...
  Scenario: Home Page - Validation of UI Elements
    ...
    Then I should see the below mentioned Header Social Media items on the Home Page
      | Header1  | Header2 | Header3     | Header4   | Header5  | Header6 | Header7 | Header8     |
      | Facebook | Twitter | Google_Plus | Instagram | Linkedin | Youtube | RSS     | Dailymotion |
    Then I should see the below mentioned Aritcles & Sections items on the Home Page
    ...
    Then I should see the below mentioned Sticky Header after Scrolling items on the Home Page
      ...
      | Vijesti             | Teme                | Mišljenja           | Programi            | Video               | Blog                | Interaktivno        | Vrijeme             | Uživo               |
    Then I should see the below mentioned Footer items on the Home Page
      | Footer_Menu1 | Footer_Menu2   | Footer_Menu3       |
      | Al_Jazeera   | Mobilne_usluge | Korisnička_pravila |
    Then I should see the below mentioned Footer Section-1 items on the Home Page
    ...
    Then I should see the below mentioned Footer Section-2 items on the Home Page
